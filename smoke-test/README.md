...
# cp smoke-test/manifests/manifest.jobset.sample.yaml manifest.yaml
...
```bash
> python main.py --help
usage: main.py [-h] [--operator {ray,kuberay,jax,pytorch,xgboost,jobset}] [--sleep SLEEP] [--tb-write TB_WRITE]

AIchor Smoke test on any operator

options:
  -h, --help            show this help message and exit
  --operator {ray,kuberay,jax,pytorch,xgboost,jobset}
                        operator name
