...
if __name__ == "__main__":
    ...
    parser.add_argument("--operator", type=str, default="tf", choices=["ray", "jax", "tf", "pytorch", "xgboost"],help="operator name")
    ...
    if args.operator == "ray":
        ...
        tfop()
    elif args.operator == "pytorch":
        pytorchop()
    elif args.operator == "xgboost":
        xgboostop()
